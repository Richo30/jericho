...
<head>
    ...
    <title>Jericho Magpantay | Personal Page</title>
    <link rel="icon" type="image/x-icon" href="assets/imgs/avatar.jpg">
    <!-- font icons -->
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <header class="header">
        <div class="container">
            <ul class="social-icons pt-3">
                <li class="social-item"><a class="social-link text-dark" href="https://www.facebook.com/jemagpantay30/"><i class="ti-facebook" aria-hidden="true"></i></a></li>
                ...
                <li class="social-item"><a class="social-link text-dark" href="https://www.instagram.com/jrchmgpntay_/"><i class="ti-instagram" aria-hidden="true"></i></a></li>
                <li class="social-item"><a class="social-link text-dark" href="https://github.com/Richo30"><i class="ti-github" aria-hidden="true"></i></a></li>
            </ul>

            <div class="header-content">
                <h4 class="header-subtitle" >Hello, I am</h4>
                <h1 class="header-title">Jericho</h1>
                <h6 class="header-mono" >Web Designer | Full Stack Developer</h6>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    ...
                    <li class="brand-txt">
                        <h5 class="brand-title">Jericho</h5>
                        <div class="brand-subtitle">Web Designer | Full Stack Developer</div>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">A Full Stack Web Designer / Developer Located In Our Lovely Earth</h5>
                <p class="mt-20">Any fool can write code that a computer can understand. Good programmers write code that humans can understand.” – Martin Fowler</p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 11/30/1998</li>
                    <li><span>Email</span> : jemagpantay30@gmail.com</li>
                    <li><span>Phone</span> : + (639) 128-877498</li>
                    <li><span>Skype</span> : Jericho_Jover </li>
                    <li><span>Address</span> :  General Trias City, Cavite</li>
                </ul>
                <ul class="social-icons pt-3">
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>UX Design</h6>
                        <p class="subtitle"> process design teams use to create products that provide meaningful and relevant experiences to users.</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle">building and maintenance of websites</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle"> a craft where professionals create visual content to communicate messages</p>
                        <hr>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P>Full Stack Developer | UX Design | Graphics Designer</P>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            <h6 class="title text-danger">2015 - 2020</h6>
                            <P>Bachelor of Science in Information Technology</P>
                            <P class="subtitle">Cavite State University - Indang Cavite</P>
                            <hr>
                            <h6 class="title text-danger">2011 - 2015</h6>
                            <P>High School Degree</P>
                            <P class="subtitle">Governor Ferrer Memorial National High School - General Trias City, Cavite</P>
                            <hr>
                            <h6 class="title text-danger">2011 - 2005</h6>
                            <P>Elementary Degree</P>
                            <P class="subtitle">Tapia Elementary School - General Trias City, Cavite</P>
                       ...
                       <div class="card-header">
                        ...
                        <div class="card-body pb-2">
                           <h6>HTML &amp; CSS</h6>
                            ...
                            <h6>Flutter - Dart</h6>
                            <div class="progress mb-3">
                                <div class="progress-bar bg-danger" role="progressbar" style="width: 5%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <h6>Photoshop</h6>
                            <div class="progress mb-3">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="row ">
                        ...
                        <div class="col-7 text-left py-3">
                            ...
                            <p class="text-light mb-1">Worked Hours</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    ...
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Management System</h5>
                            <P class="subtitle"> a set of policies, processes and procedures used by an organization to ensure that it can fulfill the tasks required to achieve its objectives. These objectives cover many aspects of the organization's operations.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            ...
                            <P class="subtitle">companies and individuals that buy and sell goods and services over the Internet.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Profiling System</h5>
                            <P class="subtitle">system designed by the Administrator to identify unemployment compensation benefit recipients who are likely to exhaust regular benefits and need reemployment services to make a successful transition to new employment.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Personal Logo</h5>
                            <P class="subtitle">create will be an extension of you as an artist, graphic designer, writer, and so on. </P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Cellphone & Laptop Repair</h5>
                            <P class="subtitle">offers repair service for many electronic gadgets… “many” meaning that not all gadgets have parts available or are worth repairing when considering the cost of parts and labor versus buying new.</P>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
                    <div class="card mb-5">
                       <div class="card-header has-icon">
                        ...
                        <div class="card-body px-4 py-3">
                            <h5 class="mb-3 card-title text-dark">Mobile App</h5>
                            <P class="subtitle">oftware application developed specifically for use on small, wireless computing devices, such as smartphones and tablets, rather than desktop or laptop computers.</P>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section bg-dark py-5">
        <div class="container text-center">
            <h2 class="text-light mb-5 font-weight-normal">I am available or FreeLance</h2>
                ...
                <div class="portfolio-container">
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/web-1.jpg" class="img-fluid" alt="Jericho Magpantay">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/web-2.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/advertising-2.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web">
                        <div class="portfolio-item">
                            <img src="assets/imgs/web-4.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising">
                        <div class="portfolio-item">
                            <img src="assets/imgs/advertising-1.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/web-3.jpg" class="img-fluid" alt="Jericho Magpantay">
                           <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/advertising-3.jpg" class="img-fluid" alt="Jericho Magpantay">
                           <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 advertising new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/advertising-4.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/branding-1.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="assets/imgs/branding-2.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/branding-3.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="assets/imgs/branding-4.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 branding">
                        <div class="portfolio-item">
                            <img src="assets/imgs/branding-5.jpg" class="img-fluid" alt="Jericho Magpantay">
                            <div class="content-holder">
                    ...
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            <img src="assets/imgs/web-5.jpg" class="img-fluid" alt="Jericho Magpantay">
                           <div class="content-holder">
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+ (639) 128-877498</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">General Trias City. Cavite</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">jemagpantay30@gmail.com</span></h6>
                            </div>
                        </div>
